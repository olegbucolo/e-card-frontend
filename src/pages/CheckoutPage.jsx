            ...
            <div className="w-30 py-3 px-3">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input name="customerName" type="text" className="form-control" id="customer-name" placeholder='inserisci il tuo nome: ' value={order.customerName} onChange={handleChange} />
                    </div>

                    <div className="mb-3">
                        <label htmlFor="customer-surname" className="form-label d-flex align-self-start">Inserisci il tuo cognome: </label>
                        <input name="customerSurname" type="text" className="form-control" id="customer-surname" placeholder='inserisci il tuo cognome: ' value={order.customerSurname} onChange={handleChange} />
                    </div>

                    <div className="mb-3">
                        <label htmlFor="customer-mail" className="form-label d-flex align-self-start">Inserisci la tua Email: </label>
                        <input name="customerMail" type="text" className="form-control" id="customer-mail" placeholder='Inserisci la tua Email: ' value={order.customerMail} onChange={handleChange} />
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <input name="streetName" type="text" className="form-control" id="street-name" placeholder='Inserisci il tuo indirizzo di residenza: ' value={order.streetName} onChange={handleChange} />
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <input name="city" type="text" className="form-control" id="city" placeholder='Inserisci la tua città di residenza: ' value={order.city} onChange={handleChange} />
                    </div>
