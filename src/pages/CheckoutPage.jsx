        ...
        <>
            <div className="main-container-checkout">
                ...
                <div className="checkout-container d-flex justify-content-around">
                    <form onSubmit={handleSubmit} className="checkout-form mt-5 py-4 px-3 d-block d-md-grid px-5">

                        {/* campo nome utente */}
                        <div className="">
                            <label htmlFor="customer-name" className="form-label d-flex align-self-start">Nome: </label>
                            <input name="customerName" type="text" pattern="[A-Za-zÀ-ÿ\s]+" className={submitted && !order.customerName ? "input-error form-control" : "form-control"} id="customer-name" value={order.customerName} onChange={handleChange} />
                        </div>

                        {/* campo cognome utente */}
                        <div className="mb-3">
                            <label htmlFor="customer-surname" className="form-label d-flex align-self-start">Cognome: </label>
                            <input name="customerSurname" type="text" pattern="[A-Za-zÀ-ÿ\s]+" className={submitted && !order.customerSurname ? "input-error form-control" : "form-control"} id="customer-surname" value={order.customerSurname} onChange={handleChange} />
                        </div>

                        {/* campo mail */}
                        <div className="mb-3">
                            <label htmlFor="customer-mail" className="form-label d-flex align-self-start">Email: </label>
                            <input name="customerMail" type="email" className={submitted && !order.customerMail ? "input-error form-control" : "form-control"} id="customer-mail" value={order.customerMail} onChange={handleChange} />
                        </div>

                        {/* campo numero telefono utente */}
                        <div className="mb-3">
                            <label htmlFor="phone" className="form-label d-flex align-self-start">Telefono: </label>
                            <input name="phone" type="tel" pattern="^\+?[0-9]{8,15}$" className={submitted && !order.phone ? "input-error form-control" : "form-control"} id="phone" value={order.phone} onChange={handleChange} />
                        </div>

                        {/* campo numero civico utente */}
                        <div className={`mb-3 ${sameBilling ? "d-none" : ""}`}>
                            <label htmlFor="street-name-billing" className="form-label d-flex align-self-start">Indirizzo di spedizione: </label>
                            <input name="streetNameBilling" type="text" className={submitted && !order.streetNameBilling ? "input-error form-control" : "form-control"} id="street-name-billing" value={order.streetNameBilling} onChange={handleChange} />
                        </div>

                        {/* campo nome via utente */}
                        <div className="mb-3">
                            <label htmlFor="street-name" className="form-label d-flex align-self-start">Citta' di spedizione: </label>
                            <input name="streetName" type="text" className={submitted && !order.streetName ? "input-error form-control" : "form-control"} id="street-name" value={order.streetName} onChange={handleChange} />
                        </div>

                        {/* campo nome città utente */}
                        <div className="mb-3">
                            <label htmlFor="city" className="form-label d-flex align-self-start">Città di residenza: </label>
                            <input name="city" type="text" className={submitted && !order.city ? "input-error form-control" : "form-control"} id="city" value={order.city} onChange={handleChange} />
                        </div>

                        {/* campo città di fatturazione utente */}
                        <div className={`mb-3 ${sameBilling ? "d-none" : ""}`}>
                            <label htmlFor="city-billing" className="form-label d-flex align-self-start">Città di spedizione: </label>
                            <input name="cityBilling" type="text" className={submitted && !order.cityBilling ? "input-error form-control" : "form-control"} id="city-billing" value={order.cityBilling} onChange={handleChange} />
                        </div>

                        {/* campo codice postale utente */}
                        <div className="mb-3">
                            <label htmlFor="postal-code" className="form-label d-flex align-self-start">CAP: </label>
                            <input name="postalCode" type="text" pattern="[0-9]{5}" className={submitted && !order.postalCode ? "input-error form-control" : "form-control"} id="postal-code" value={order.postalCode} onChange={handleChange} />
                        </div>
                        ...
                        <div className={`mb-3 ${sameBilling ? "d-none" : ""}`}>
                            ...
                            <input name="postalCodeBilling" type="text" pattern="[0-9]{5}" className={submitted && !order.postalCodeBilling ? "input-error form-control" : "form-control"} id="postal-code-billing" value={order.postalCodeBilling} onChange={handleChange} />
                        </div>

                        {/* campo provincia utente */}
                        <div className="mb-3">
                            <label htmlFor="province" className="form-label d-flex align-self-start">Provincia: </label>
                            <input name="province" type="text" pattern="[A-Za-zÀ-ÿ\s]+" className={submitted && !order.province ? "input-error form-control" : "form-control"} id="province" value={order.province} onChange={handleChange} />
                        </div>
                        ...
                        <div className={`mb-3 ${sameBilling ? "d-none" : ""}`}>
                            ...
                            <input name="provinceBilling" type="text" className={submitted && !order.provinceBilling ? "input-error form-control" : "form-control"} id="provinceBilling" value={order.provinceBilling} onChange={handleChange} />
                        </div>

                        {/* campo Paese/Nazione utente */}
                        <div className="mb-3">
                            <label htmlFor="country" className="form-label d-flex align-self-start">Paese: </label>
                            <input name="country" type="text" pattern="[A-Za-zÀ-ÿ\s]+" className={submitted && !order.country ? "input-error form-control" : "form-control"} id="country" value={order.country} onChange={handleChange} />
                        </div>
                        ...
                        <div className={`mb-3 ${sameBilling ? "d-none" : ""}`}>
                            ...
                            <input name="countryBilling" type="text" className={submitted && !order.countryBilling ? "input-error form-control" : "form-control"} id="country-billing" value={order.countryBilling} onChange={handleChange} />
                        </div>
